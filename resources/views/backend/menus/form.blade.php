		...
		<div class="row">
			<div class="col-12">
				<div class="main-card mb-3 card">
					<!-- form start -->
					<form id="roleFrom" role="form" method="POST" action="{{ isset($menu) ? route('app.menus.update', $menu->id) : route('app.menus.store') }}">
						@csrf
						@if (isset($menu))
							@method('PUT')
						@endif
						<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter menu name (e.g. admin)" value="{{ isset($menu) ? $menu->name : old('name') }}" required autofocus>
								@error('name')
